...
interfaces/%.o: ../interfaces/%.c interfaces/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-interfaces

clean-interfaces:
	-$(RM) ./interfaces/register_io_i2c.d ./interfaces/register_io_i2c.o ./interfaces/register_io_spi.d ./interfaces/register_io_spi.o ./interfaces/sensor_io_i2c.d ./interfaces/sensor_io_i2c.o ./interfaces/sensor_io_spi.d ./interfaces/sensor_io_spi.o
